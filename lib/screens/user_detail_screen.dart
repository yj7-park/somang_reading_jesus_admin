            ...
            child: Column(
              children: [
                ...
                TextField(
                  ...
                  readOnly: true,
                  decoration: const InputDecoration(labelText: "전화번호 (수정 불가)"),
                ),
                const SizedBox(height: 10),
                TextField(
                  controller: _dobCtrl,
                            ...
                            for (final holiday in _currentSchedule!.holidays) {
                              if ((day.isAfter(holiday.start) ||
                                  ...
                                  (day.isBefore(holiday.end) ||
                                      DateHelper.isSameDay(day, holiday.end))) {
                                return true;
                              }
                            }
                            return false;
                              ...
                              if (_currentSchedule != null) {
                                for (final h in _currentSchedule!.holidays) {
                                  if ((day.isAfter(h.start) ||
                                          DateHelper.isSameDay(day, h.start)) &&
                                      (day.isBefore(h.end) ||
                                          DateHelper.isSameDay(day, h.end))) {
                                    holiday = h;
                                    break;
                                  }
                                }
